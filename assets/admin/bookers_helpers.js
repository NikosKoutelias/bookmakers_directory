    ...
    updateCustomShortcode = function () {
        ...
        jQuery('#order_by').each(function () {
            if (jQuery(this).val() != '' && jQuery('#sort_by').val()!= '') {
                attrs = attrs + ' ' + jQuery('#sort_by').attr('data-attribute') + '="' + jQuery(this).val() + ' '+ jQuery('#sort_by').val() +'"';
            }else if (jQuery(this).val() != '' && jQuery('#sort_by').val() == '') {

                attrs = attrs + ' ' + jQuery('#sort_by').attr('data-attribute') + '="' + jQuery(this).val() + '"';
            }else{
                attrs = attrs + ' ' + jQuery('#sort_by').attr('data-attribute') + '="' + jQuery('#sort_by').val() + '"';
            }
        });
        ...
        if ( (document.getElementById("sorting_id").checked)){
            ...
            if(mVal != '') attrs = attrs + ' ' + jQuery('#sortlist').attr('data-attribute') + '="' + mVal + '"';
        }
